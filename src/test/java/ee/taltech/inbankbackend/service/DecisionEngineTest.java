...
class DecisionEngineTest {
    ...
    void setUp() {
        ...
        overAgedPersonalCode = "34001084212";
        underAgedPersonalCode = "61001084212";
    }
    ...
    void testSegment1PersonalCode() throws InvalidLoanPeriodException, NoValidLoanException,
            InvalidPersonalCodeException, InvalidLoanAmountException, InvalidLoanClientAgeException {
    ...
    @Test
    void testInvalidLoanClientAgeOverAged() {
        assertThrows(InvalidLoanClientAgeException.class,
                () -> decisionEngine.calculateApprovedLoan(overAgedPersonalCode, 2000L, 12));
    }

    @Test
    void testInvalidLoanClientAgeUnderAged() {
        assertThrows(InvalidLoanClientAgeException.class,
                () -> decisionEngine.calculateApprovedLoan(underAgedPersonalCode, 2000L, 12));
    }
